...
\caption{(\#tab:new tabulate-descriptive-statistics)\label{tab:descriptive-statistics}Descriptive statistics of variables}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lll}
\toprule
...
\hspace{1em}Age 1 & Dummy variable: 1 if Age Less18 - 34 years & 57.5 \%\\
\hspace{1em}Age 2 & Dummy variable: 1 if Age 35-54 years & 30.3 \%\\
\hspace{1em}Age 3 & Dummy variable: 1 if Age 55 to 65 and more years & 12.2 \%\\
\hspace{1em}Income 1 & Dummy variable: 1 if Income 423to639 & 31 \%\\
\hspace{1em}Income 2 & Dummy variable: 1 if Income 639to1550 & 35.1 \%\\
\hspace{1em}Income 3 & Dummy variable: 1 if Income 1550to2380 more & 33.9 \%\\
\hspace{1em}Education 1 & Dummy variable: 1 if Education ELEMENTARY & 2.3 \%\\
\hspace{1em}Education 2 & Dummy variable: 1 if Education SECUNDARY to POSTGRAD & 97.7 \%\\
\hspace{1em}Primary Mode 1 & Dummy variable: 1 if Primary Mode CAR and MOTO & 26.5 \%\\
\hspace{1em}Primary Mode 2 & Dummy variable: 1 if Primary Mode TAXI, COLECTIVO, METRO, BUS & 64.3 \%\\
...
\caption{\label{tab:unnamed-chunk-23}\label{tab:Bivariate ordered model}Estimation Results}
\centering
\resizebox{\linewidth}{!}{
\fontsize{8}{10}\selectfont
