...
\caption{\label{tab:unnamed-chunk-23}\label{tab:Definitions}Definitions of variables}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lll}
\toprule
Variable & Note & Subcategory\\
\midrule
\addlinespace[0.3em]
...
\hspace{1em}Education & Level of education of respondents in Santiago in 2016 & Elementary, Secondary, Professor, College, Postgrad\\
...
\caption{\label{fig:Income level}Income level}\label{fig:unnamed-chunk-26}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-37}\label{tab:Bivariate ordered model}Estimation Results}
\centering
\resizebox{\linewidth}{!}{
\fontsize{8}{10}\selectfont
