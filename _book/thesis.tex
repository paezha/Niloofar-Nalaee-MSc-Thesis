...
In addition to stress-related factors such as workplace and labour market, personal characteristics, environmental, and interpersonal factors, commuting plays a significant role as a source of stress, classified into objective stressors and subjective moderators. The first category called impedance, includes commuting condition-related factors such as commuting time, distance or speed and the second one refers to the perception and feeling of control over the commute, predictability of the journey's conditions and personal characteristics like gender, income and age (Gottholmseder, Nowotny, Pruckner, \& Theurl, 2009).
...
Novaco \& Gonzalez (2009) also pointed out that the term ``commuting stress'' has been mentioned in a very appropriate way in the book by Koslowsky, Kluger, and Reich (1995, as cited in Novaco \& Gonzalez, 2009), who provide an engaging composition of the environmental, psychological, personal health, and organizational factors involved. They offer an elaborate structural model and provide a rich discussion of coping at the individual, organizational, and governmental levels.
...
\begin{itemize}
\item
  To develop a reproducible data package including various travel behavioural and psychological aspects of commuters' daily movements.
\item
...
The data presented in this article result from an effort to purposefully collect data on various aspects of the experience of living and moving in a major city in the Global South. This data set comprises a wide range of sections and the health information section serves as the foundation for the analysis in the next chapter.
...
Furthermore, other themes include social interactions by mode of transportation, mode shifting and use of information technologies, self-assessed health responses, feelings and emotions as they relate to the commute experience, attitudes concerning how well transportation systems satisfy the needs of respondents, and attitudes about nature and sustainability.
...
\section{How does data preprocessing contribute to reproducibility?}\label{how-does-data-preprocessing-contribute-to-reproducibility}}
...
\begin{longtable}[t]{>{\raggedright\arraybackslash}p{3em}>{\raggedright\arraybackslash}p{4em}>{\raggedleft\arraybackslash}p{4em}>{\raggedleft\arraybackslash}p{3em}>{\raggedleft\arraybackslash}p{1em}>{\raggedleft\arraybackslash}p{1em}>{\raggedleft\arraybackslash}p{1em}>{\raggedleft\arraybackslash}p{2em}>{\raggedleft\arraybackslash}p{2em}>{\raggedright\arraybackslash}p{3em}>{\raggedleft\arraybackslash}p{1em}>{\raggedright\arraybackslash}p{3em}>{\raggedleft\arraybackslash}p{4em}>{\raggedleft\arraybackslash}p{4em}>{\raggedleft\arraybackslash}p{3em}>{\raggedleft\arraybackslash}p{1em}>{\raggedleft\arraybackslash}p{1em}>{\raggedleft\arraybackslash}p{1em}>{\raggedleft\arraybackslash}p{1em}}
...
\toprule
Type & Variable & Missing & Complete Rate & Ch Min & Ch Max & Empty & Ch Levels & W Space & Ordinal & N Levels & Counts & Mean & SD & P0 & P25 & P50 & P75 & P100\\
\midrule
\endfirsthead
\caption[]{\label{tab:unnamed-chunk-6}Variables Regarding Individual Characteristics of Respondents \textit{(continued)}}\\
\toprule
Type & Variable & Missing & Complete Rate & Ch Min & Ch Max & Empty & Ch Levels & W Space & Ordinal & N Levels & Counts & Mean & SD & P0 & P25 & P50 & P75 & P100\\
\midrule
\endhead
...
In terms of the level of satisfaction with their current job, we see that almost 60\% of respondents are at least highly satisfied. We also see that long commutes are frequent in this sample, with about one-third of respondents spending 1 h or more travelling and about one-quarter of respondents spending between 40 minutes and one hour in their daily commute. This distribution is noteworthy because time spent commuting has been recognized as a factor that can affect physical and mental health and well-being in particular in association with motorized transportation (Brutus, Javadian, \& Panaccio, 2017).

The most common time of the day for commuting is between 7 am and 9 am, but there are also 171 missing responses in this column, so not much can be read from it. Finally, we note that many people spend 35,000-75,000 pesos monthly on their transportation expenditure.
...
\midrule
\endfirsthead
\caption[]{\label{tab:unnamed-chunk-11}Variables Regarding the Commuting Behavior of Respondents \textit{(continued)}}\\
\toprule
Type & Variable & Missing & Complete Rate & Ordinal & Levels & Counts\\
\midrule
\endhead
...
When asked to rate the level of interaction with other people during their usual trips, respondents in terms of the level of interaction people have with others during their usual trips, most of them presumed a good level and they moderately feel it is important when they consider the presence of other people during their usual travels (\texttt{r4A\_INTERACC}) a plurality of responses are ``POOR'' or ``FAIR'' (187) and only 73, that is 16.2\% of respondents, rate their level of interaction as ``GOOD'' or ``EXCELLENT'' report poor or fair (there are 13 missing responses).

Concerning the presence of other people during their travels, the responses tend to be somewhat more ambivalent, and the difference between those for whom this is less or more important is smaller (157 responses are ``NOT'' or only ``SLIGHTLY IMPORTANT'' whereas 132 responses are ``IMPORTANT'' or ``VERY IMPORTANT'').
...
\midrule
\endfirsthead
\caption[]{\label{tab:unnamed-chunk-12}Variables Regarding Social Interactions of Respondents \textit{(continued)}}\\
\toprule
Type & Variable & Missing & Complete Rate & Ordinal & Levels & Counts\\
\midrule
\endhead
...
\begingroup\fontsize{7}{9}\selectfont
\begin{longtable}[t]{ll>{\raggedleft\arraybackslash}p{3em}>{\raggedleft\arraybackslash}p{3em}l>{\raggedleft\arraybackslash}p{3em}>{\raggedright\arraybackslash}p{10em}}
\caption{\label{tab:unnamed-chunk-14}\label{tab:ITC-Shifting-Descriptives}Variables Regarding Information, Telecommunications, and Mode Shifting of Respondents}\\
\toprule
Type & Variable & Missing & Complete Rate & Ordinal & Levels & Counts\\
\midrule
\endfirsthead
\caption[]{\label{tab:unnamed-chunk-14}Variables Regarding Information, Telecommunications, and Mode Shifting of Respondents \textit{(continued)}}\\
\toprule
Type & Variable & Missing & Complete Rate & Ordinal & Levels & Counts\\
\midrule
\endhead
...
\bottomrule
\endlastfoot
factor & BE\_Autospace & 10 & 0.98 & TRUE & 5 & GOOD: 127, VERY GOOD: 117, FAIR: 72, EXCELLENT: 67\\
factor & BE\_Parking\_num & 10 & 0.98 & TRUE & 5 & GOOD: 119, FAIR: 96, VERY GOOD: 88, POOR: 85\\
factor & BE\_Quality\_highway & 11 & 0.98 & TRUE & 5 & VERY GOOD: 142, GOOD: 141, FAIR: 67, EXCELLENT: 49\\
factor & BE\_Space\_pedestrian & 10 & 0.98 & TRUE & 5 & GOOD: 141, VERY GOOD: 102, FAIR: 82, EXCELLENT: 68\\
factor & BE\_Quality\_sidewalk & 9 & 0.98 & TRUE & 5 & GOOD: 119, FAIR: 110, VERY GOOD: 99, POOR: 67\\
\addlinespace
factor & BE\_Clean\_busstop & 9 & 0.98 & TRUE & 5 & POOR: 129, FAIR: 108, GOOD: 102, VERY GOOD: 67\\
factor & BE\_Seat\_busstop & 9 & 0.98 & TRUE & 5 & POOR: 142, FAIR: 122, GOOD: 94, VERY GOOD: 53\\
factor & BE\_Climateprotection\_busstop & 10 & 0.98 & TRUE & 5 & POOR: 156, FAIR: 139, GOOD: 88, VERY GOOD: 36\\
factor & BE\_cycloway\_num & 9 & 0.98 & TRUE & 5 & POOR: 189, FAIR: 96, GOOD: 84, VERY GOOD: 37\\
factor & BE\_Quality\_cycloway & 9 & 0.98 & TRUE & 5 & POOR: 171, FAIR: 96, GOOD: 96, VERY GOOD: 44\\
\addlinespace
factor & BE\_Bikeshare & 9 & 0.98 & TRUE & 5 & POOR: 177, GOOD: 100, FAIR: 69, EXCELLENT: 49\\
factor & BE\_Imp\_Autospace & 12 & 0.97 & TRUE & 5 & VERY IMPORTANT: 140, MODERATELY IMPORTANT: 104, IMPORTANT: 95, SLIGHTLY IMPORTANT: 56\\
factor & BE\_Imp\_Parking\_num & 12 & 0.97 & TRUE & 5 & VERY IMPORTANT: 152, MODERATELY IMPORTANT: 102, IMPORTANT: 91, SLIGHTLY IMPORTANT: 51\\
factor & BE\_Imp\_Quality\_highway & 11 & 0.98 & TRUE & 5 & VERY IMPORTANT: 214, IMPORTANT: 100, MODERATELY IMPORTANT: 82, NOT IMPORTANT: 23\\
factor & BE\_Imp\_Space\_pedestrian & 11 & 0.98 & TRUE & 5 & VERY IMPORTANT: 278, IMPORTANT: 103, MODERATELY IMPORTANT: 41, NOT IMPORTANT: 10\\
\addlinespace
factor & BE\_Imp\_Quality\_sidewalk & 11 & 0.98 & TRUE & 5 & VERY IMPORTANT: 297, IMPORTANT: 86, MODERATELY IMPORTANT: 35, SLIGHTLY IMPORTANT: 12\\
factor & BE\_Imp\_Clean\_busstop & 11 & 0.98 & TRUE & 5 & VERY IMPORTANT: 286, IMPORTANT: 92, MODERATELY IMPORTANT: 39, SLIGHTLY IMPORTANT: 13\\
...
\midrule
\endfirsthead
\caption[]{\label{tab:unnamed-chunk-16}Variables Regarding Health Information of Respondents \textit{(continued)}}\\
\toprule
Type & Variable & Missing & Complete Rate & Ordinal & Levels & Counts\\
\midrule
\endhead
...
\midrule
\endfirsthead
\caption[]{\label{tab:unnamed-chunk-17}Variables Regarding Feelings and Emotions of Respondents \textit{(continued)}}\\
\toprule
Type & Variable & Missing & Complete Rate & Ordinal & Levels & Counts\\
\midrule
\endhead
...
\midrule
\endfirsthead
\caption[]{\label{tab:unnamed-chunk-18}Variables Regarding Decision-making and Planning of Respondents \textit{(continued)}}\\
\toprule
Type & Variable & Missing & Complete Rate & Ordinal & Levels & Counts\\
\midrule
\endhead
...
\midrule
\endfirsthead
\caption[]{\label{tab:unnamed-chunk-19}Variables Regarding Perspectives about Nature and Sustainability of Respondents \textit{(continued)}}\\
\toprule
Type & Variable & Missing & Complete Rate & Ordinal & Levels & Counts\\
\midrule
\endhead
...
The current summary of the Santiago dataset reflects a commitment to ensuring reproducibility through various stages, including data collection, cleaning, preprocessing, documentation, storage, and version control.
...
The correlation coefficient between H\_Stress and H\_Imp\_stress represents the correlation between the error terms of the two dependent variables. In the current study as Table (see Table \ref{tab:Bivariate ordered model}) reveals, the estimated correlation coefficient is 0.250344, indicating a positive correlation between the error terms. This positive correlation coefficient suggests that there may be shared or common unobserved factors influencing both stress levels and the importance of stress levels.
