...
knitr::kable(skim_IC,
  ...
  column_spec(16, width = "1em") %>%
  column_spec(17, width = "1em") %>%
  column_spec(18, width = "1em") %>%
  column_spec(19, width = "1em") %>%
...
```{r summary-ITC-and-shifting, tbl-cap: Variables Regarding Information, Telecommunications, and Mode Shifting of Respondents, tbl-cap-location: top, label: tbl-ITC-Shifting-Descriptives, echo: false, include=FALSE}
...
knitr::kable(skim_SIS,
             ...
             longtable = TRUE,
             col.names = c("Type", "Variable", "Missing", "Complete Rate", "Ordinal", "Levels", "Counts"),
             caption = "\\label{tab:ITC-Shifting-Descriptives}Variables Regarding Information, Telecommunications, and Mode Shifting of Respondents") %>%
  column_spec(3, width = "3em") %>%
  column_spec(4, width = "3em") %>%
  column_spec(6, width = "3em") %>%
  column_spec(7, width = "10em") %>%
