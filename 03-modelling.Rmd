...
definitions <- data.frame(Variable = c ("Age",
                                        "Income",
                                        "Main_mode",
                                        "Education",
                                        "Occupation",
...
Subcategory = c ("[Less18], [from18to24years], [from25to34years], [from35to54years], [55to64year], [from65more]",
...
kable(definitions,
  ...
  pack_rows("Socio-Economic and Demographic Attributes", 1, 5) %>%
  pack_rows("Stress Characteristics", 6, 7) 
